...
COMMIT="460b8f151a1a0054bf84c54f0e60617b52fc8a47"
BUILDER="portal360-preflight-"+str(os.getpid())
TAG="portal360/paperclip-candidate:460b8f151-preflight"
...
assert free()>22*GIB, "Insufficient initial disk reserve"
...
report={"commit":COMMIT,"started_at":datetime.datetime.now(datetime.timezone.utc).isoformat(),
        "image_tag":TAG,"builder":BUILDER,"free_bytes_before":free(),"build_timeout_seconds":1800,
...
try:
    ...
    args=["docker","buildx","build","--builder",BUILDER,"--target","production",
          ...
          "--build-arg","PAPERCLIP_BUILD_VERSION=candidate-460b8f151",
